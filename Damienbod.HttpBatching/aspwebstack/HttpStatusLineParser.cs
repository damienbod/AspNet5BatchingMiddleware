            ...
            HttpUnsortedResponse httpResponse)
        {
            ...
            switch (statusLineState)
            {
                case HttpStatusLineState.BeforeVersionNumbers:
                    ...
                    {
                        throw new FormatException(Error.Format("HttpInvalidVersion", version, FormattingUtilities.HttpVersionToken));
                    }
                ...
                case HttpStatusLineState.StatusCode:
                    ...
                    {
                        throw new FormatException(Error.Format("HttpInvalidStatusCode", statusCode, 100, 1000));
                    }
